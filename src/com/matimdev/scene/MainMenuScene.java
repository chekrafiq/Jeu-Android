...
public class MainMenuScene extends BaseScene implements IOnMenuItemClickListener
{
	...
	{
		attachChild(new Sprite(500, 500, resourcesManager.menu_background_region, vbom)
		{
    		@Override
	...
	private void createMenuChildScene()
	{
		...
		menuChildScene.setPosition(10, 24);
		...
		//menuChildScene.setBackground("menu_background.png");
